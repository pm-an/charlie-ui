      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          {messages.length === 0 && (
            <div className="flex-1 flex items-center justify-center h-full">
              <p className="text-sm text-white/30">No messages yet. Start a conversation.</p>
            </div>
          )}
          {messages.map((message) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span className="text-xs text-white/40 mb-1">{message.sender}</span>
                  <div
                    className={cn(
                  ...
                  <span className="text-xs text-white/30 mt-1">{message.timestamp}</span>
                </div>
              </div>
            );
          })}
        ...
        >
          <input
            ...
            className="flex-1 bg-white/5 border border-white/[0.06] rounded-lg px-3 py-2 text-sm text-white placeholder:text-white/30 outline-none focus:border-white/15 transition-colors"
          />
          <button
            type="submit"
