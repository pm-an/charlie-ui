    ...
    variants: {
      variant: {
        default: [
          ...
          "text-fg-200 hover:bg-bg-subtle-hover hover:text-text-loud",
        ],
        ghost: [
          "bg-transparent text-fg-200",
          "hover:bg-bg-subtle hover:text-text-loud",
        ],
        outline: [
          "border border-border-strong text-fg-200",
