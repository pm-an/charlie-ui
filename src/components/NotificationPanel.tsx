              ...
              >
                ...
                <div className="h-8 w-8 rounded-full bg-white/10 shrink-0 flex items-center justify-center overflow-hidden">
                  {notification.avatar ? (
                    ...
                    <span className="text-white/70">{notification.icon}</span>
                  ) : (
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-white/70 mt-1">{notification.timestamp}</p>
                </div>
                ...
                {onDismiss && (
                  <button
                    ...
                    className="opacity-0 group-hover:opacity-100 transition-opacity shrink-0 p-1 text-white/70 hover:text-white/70 self-start"
                  >
